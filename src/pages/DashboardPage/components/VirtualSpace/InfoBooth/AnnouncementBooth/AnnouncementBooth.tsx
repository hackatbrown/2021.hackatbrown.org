...
const SUBMISSION_ANNOUNCEMENTS = "Remember to submit your project by 1PM!";

const REMIND_SUBMISSION_TIME = new Date("January 24, 2021 12:00:00 EST"); // Remember to change to 1/24!
