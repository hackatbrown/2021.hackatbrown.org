...
  render(){
    ...
    let button;
    console.log("RIGHT BREOFRE BUTTON");
    console.log(this.state.user);
    if (this.state.user != null) {
      button =
      <button onClick={
        (this.props.firebase == null) ? () => {} : this.props.firebase.doLogOut
      }>Log out</button>
    } else {
      button = <button className="round-clear-button" onClick={this.show}>Log in / Join</button>
    }
